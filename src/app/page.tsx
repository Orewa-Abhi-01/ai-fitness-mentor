      ...
      <section className="relative z-10 py-24 flex-grow">
        <div className="container mx-auto px-14">
          <div className="grid grid-cols-1 lg:grid-cols-12  gap-8 items-center relative">
            {/* CORNER DECORATION */}
            <div className="absolute  -top-10 left-0  size-40 border-l-2 border-t-2  border-primary " />

            {/* LEFT SIDE CONTENT */}
            <div className="col-span-1 lg:col-span-7 space-y-8 relative px-4  ">
              ...
              <p className="text-xl text-muted-foreground w-2/3 flex flex-wrap ">
            ...
            <div className="lg:col-span-5 relative">
              ...
              <div className="absolute -inset-4 pointer-events-none">
                ...
                <div className="absolute top-72 right-0 w-16 h-16 border-r-2 border-border" />
                <div className="absolute top-72 left-0 w-16 h-16 border-l-2 border-border" />
